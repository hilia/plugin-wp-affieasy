...
*/
jQuery(($)=>{(function(a){a.fn.popModal=function(c){function f(){function b(a){var b=Math.max(u,v,w);return("bottomLeft"==a?0<v:"bottomRight"==a?0<u:0<w)?a:0<v&&v==b?"bottomLeft":0<u&&u==b?"bottomRight":0<w&&w==b?"bottomCenter":a}if(e.inline)var g=d.position().left,c=d.position().top;else g=d.offset().left,c=d.offset().top;var k=parseInt(d.css("marginLeft"));parseInt(d.css("paddingLeft"));var f=parseInt(d.css("marginTop")),p=d.outerHeight(),m=d.outerWidth(),n=h.outerWidth(),q=h.outerHeight(),l,r=
